...
extension Paths.Orgs.WithOrg {
    ...
    public struct Repos {
        ...
        public struct PostRequest: Encodable {
            ...
            public init(name: String, description: String? = nil, homepage: String? = nil, isPrivate: Bool? = false, visibility: Visibility? = nil, hasIssues: Bool? = true, hasProjects: Bool? = true, hasWiki: Bool? = true, isTemplate: Bool? = false, teamID: Int? = nil, isAutoInit: Bool? = false, gitignoreTemplate: String? = nil, licenseTemplate: String? = nil, allowSquashMerge: Bool? = true, allowMergeCommit: Bool? = true, allowRebaseMerge: Bool? = true, allowAutoMerge: Bool? = false, deleteBranchOnMerge: Bool? = false) {
                self.name = name
