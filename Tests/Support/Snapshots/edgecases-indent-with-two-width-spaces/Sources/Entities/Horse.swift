...
public struct Horse: Codable {
  ...
  public enum Birthday: String, Codable, CaseIterable {
    case januaryFirst
  }
  ...
  public init(className: String, color: String? = "red", birthday: Birthday = .januaryFirst, strength: Strength? = .extreme, legCount: Int? = nil) {
