...
extension Paths {
    ...
    public struct Fake {
        ...
        public struct GetParameters {
            ...
            public init(enumQueryStringArray: [EnumQueryStringArray]?, enumQueryString: EnumQueryString?, enumQueryInteger: Int32?) {
        ...
        public struct PostRequest: Encodable {
            ...
            public init(integer: Int?, int32: Int32?, int64: Int64?, number: Double, float: Float?, double: Double, string: String?, patternWithoutDelimiter: String, byte: Data, binary: String?, date: NaiveDate?, dateTime: Date?, password: String?, callback: String?) {
        ...
        public func patch(_ body: edgecases_disable_default_values.Client) -> Request<edgecases_disable_default_values.Client> {
