...
public struct ConfigOptions: ParsableConfiguration {
    ...
    ///
    /// This property has different meanings depending on the [`format`](#format) of the generated output:
    ///
    /// - `source`: The name of the existing module/target that the generated output will be part of
    /// - `package`: The name of the new package, library and target generated by CreateAPI
